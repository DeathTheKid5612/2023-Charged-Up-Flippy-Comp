...
public class SwerveDrivetrainModel {
    ...
    public SwerveDrivetrainModel(ArrayList<SwerveModule> realModules, Gyroscope gyro){
        ...
        m_poseEstimator = new SwerveDrivePoseEstimator(SwerveConstants.KINEMATICS, getGyroscopeRotation(), getModulePositions(),SwerveConstants.DFLT_START_POSE);
    ...
    public void setKnownPose(Pose2d in) {
        ...
        m_poseEstimator.resetPosition(getGyroscopeRotation(), getModulePositions(), in);
        curEstPose = in;
    }
    ...
    public Command createCommandForTrajectory(PathPlannerTrajectory trajectory, SwerveSubsystem m_drive) {
        PPSwerveControllerCommand swerveControllerCommand =
            new PPSwerveControllerCommand(
                ...
                SwerveConstants.THETACONTROLLER,
    ...
    public double getAbsoluteAngle(int encodeNum)
    {
        return realModules.get(encodeNum).getAbsoluteEncoder().getAbsoluteAngle()*180/Math.PI;
    }
}