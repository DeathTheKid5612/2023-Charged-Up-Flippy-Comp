...
public final class Autos
{
   ...
   */
  public static CommandBase exampleAuto(SwerveSubsystem swerve, GripperSubsystem gripper)
  {
    PathPlannerTrajectory example = PathPlanner.loadPath("BasicDrive",
...
//        // position, heading(direction of travel), holonomic rotation
//                                                            );
    return Commands.sequence(new ReleaseItem(gripper).withTimeout(.35), new FollowTrajectory(swerve, example, true));
  }
